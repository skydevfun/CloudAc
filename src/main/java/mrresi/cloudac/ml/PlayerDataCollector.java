...
public class PlayerDataCollector {
    ...
    public void recordHit(Player player, Entity target) {
        ...
        if (target != null) {
            ...
            org.bukkit.Location targetCenter = target.getLocation().clone().add(0, height / 2.0, 0);
            org.bukkit.util.Vector toTarget = targetCenter.toVector().subtract(player.getEyeLocation().toVector());
